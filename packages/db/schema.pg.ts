...
export const shifts = sqliteTable("shifts", {
  ...
  departmentId: text("department_id").references(() => departments.id),
  applicableToAll: boolean("applicable_to_all")
    .notNull()
    .default(false),
  isActive: boolean("is_active").notNull().default(true),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
...
export const presenceLogs = sqliteTable("presence_logs", {
  ...
  accuracy: real("accuracy"),
  isWithinGeofence: boolean("is_within_geofence").notNull().default(true),
...
export const presenceVerificationSettings = sqliteTable("presence_verification_settings", {
  ...
  autoCheckoutOnViolation: boolean("auto_checkout_on_violation").notNull().default(false),
  ...
  criticalBatterySuspend: boolean("critical_battery_suspend").notNull().default(true),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
  updatedAt: text("updated_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
...
export const mediaUploads = sqliteTable("media_uploads", {
  ...
  completedChunks: jsonb("completed_chunks").$type<number[]>().notNull(),
  createdById: text("created_by_id").notNull().references(() => staff.id),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
  updatedAt: text("updated_at").notNull().default(sql`(current_timestamp)`),
});
...
export const aimsAgents = sqliteTable("aims_agents", {
  ...
  agentIdIdx: index("idx_pg_aims_agents_agent_id").on(t.agentId),
  agentInstIdx: index("idx_pg_aims_agents_inst").on(t.institutionId),
}));
...
export const aimsEnergyTelemetry = sqliteTable("aims_energy_telemetry", {
  ...
  energyZoneIdx: index("idx_pg_aims_energy_zone").on(t.zoneId),
  energyInstIdx: index("idx_pg_aims_energy_inst").on(t.institutionId),
}));
...
export const aimsEnergyOptimizations = sqliteTable("aims_energy_optimizations", {
  ...
  pmvConstraintSatisfied: boolean("pmv_constraint_satisfied").notNull().default(true),
  status: text("status").notNull().default("DISPATCHED"),
  institutionId: text("institution_id").notNull().default("global"),
  dispatchedAt: text("dispatched_at").notNull().default(sql`(current_timestamp)`),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  optZoneIdx: index("idx_pg_aims_opt_zone").on(t.zoneId),
  optInstIdx: index("idx_pg_aims_opt_inst").on(t.institutionId),
}));
...
export const aimsFleetVehicles = sqliteTable("aims_fleet_vehicles", {
  ...
  vehIdIdx: index("idx_pg_aims_fleet_veh_id").on(t.vehicleId),
  vehInstIdx: index("idx_pg_aims_fleet_inst").on(t.institutionId),
}));
...
export const aimsFleetDispatches = sqliteTable("aims_fleet_dispatches", {
  ...
  dispatchRouteIdx: index("idx_pg_aims_dispatch_route").on(t.routeId),
  dispatchVehIdx: index("idx_pg_aims_dispatch_veh").on(t.vehicleId),
}));
...
export const aimsBiometricLogs = sqliteTable("aims_biometric_logs", {
  ...
  bioUserIdx: index("idx_pg_aims_bio_user").on(t.userId),
  bioSeshIdx: index("idx_pg_aims_bio_sesh").on(t.sessionId),
  bioInstIdx: index("idx_pg_aims_bio_inst").on(t.institutionId),
}));
...
export const aimsCloudCosts = sqliteTable("aims_cloud_costs", {
  ...
  isSpotInstance: boolean("is_spot_instance").notNull().default(false),
  recommendationData: text("recommendation_data"), // JSON
  institutionId: text("institution_id").notNull().default("global"),
  recordedAt: text("recorded_at").notNull().default(sql`(current_timestamp)`),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  cloudResIdx: index("idx_pg_aims_cloud_res").on(t.resourceId),
  cloudInstIdx: index("idx_pg_aims_cloud_inst").on(t.institutionId),
}));
...
export const aimsCarbonMetrics = sqliteTable("aims_carbon_metrics", {
  ...
  verifiedGri: boolean("verified_gri").notNull().default(true),
  institutionId: text("institution_id").notNull().default("global"),
  recordedAt: text("recorded_at").notNull().default(sql`(current_timestamp)`),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  carbonCampusIdx: index("idx_pg_aims_carbon_campus").on(t.campusId),
  carbonInstIdx: index("idx_pg_aims_carbon_inst").on(t.institutionId),
}));
...
export const aimsCampusResources = sqliteTable("aims_campus_resources", {
  ...
  isShareableCrossCampus: boolean("is_shareable_cross_campus").notNull().default(true),
  ...
  resourceIdIdx: index("idx_pg_aims_resource_id").on(t.resourceId),
...
export const engageTemplates = sqliteTable("engage_templates", {
  ...
  engageTmplIdIdx: index("idx_pg_engage_tmpl_id").on(t.templateId),
  engageTmplChannelIdx: index("idx_pg_engage_tmpl_channel").on(t.channel),
}));
...
export const engageMessages = sqliteTable("engage_messages", {
  ...
  engageMsgIdIdx: index("idx_pg_engage_msg_id").on(t.messageId),
  engageMsgRecipientIdx: index("idx_pg_engage_msg_recipient").on(t.recipientId),
  engageMsgStatusIdx: index("idx_pg_engage_msg_status").on(t.status),
}));
...
export const engageDeliveries = sqliteTable("engage_deliveries", {
  ...
  engageDelivIdIdx: index("idx_pg_engage_deliv_id").on(t.deliveryId),
  engageDelivMsgIdx: index("idx_pg_engage_deliv_msg").on(t.messageId),
  engageDelivStatusIdx: index("idx_pg_engage_deliv_status").on(t.status),
}));
...
export const engagePreferences = sqliteTable("engage_preferences", {
  ...
  isUnsubscribedAll: boolean("is_unsubscribed_all").notNull().default(false),
  institutionId: text("institution_id").notNull().default("global"),
  updatedAt: text("updated_at").notNull().default(sql`(current_timestamp)`),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  engagePrefRecipientIdx: index("idx_pg_engage_pref_recipient").on(t.recipientId),
}));
...
export const engageWorkflows = sqliteTable("engage_workflows", {
  ...
  engageWfIdIdx: index("idx_pg_engage_wf_id").on(t.workflowId),
  engageWfTriggerIdx: index("idx_pg_engage_wf_trigger").on(t.triggerEvent),
}));
...
export const engageWorkflowRuns = sqliteTable("engage_workflow_runs", {
  ...
  engageRunIdIdx: index("idx_pg_engage_run_id").on(t.runId),
  engageRunWfIdx: index("idx_pg_engage_run_wf").on(t.workflowId),
  engageRunStatusIdx: index("idx_pg_engage_run_status").on(t.status),
}));
...
export const engageChatSessions = sqliteTable("engage_chat_sessions", {
  ...
  engageChatSeshIdIdx: index("idx_pg_engage_chat_sesh_id").on(t.sessionId),
  engageChatStakeholderIdx: index("idx_pg_engage_chat_stakeholder").on(t.stakeholderId),
  engageChatStatusIdx: index("idx_pg_engage_chat_status").on(t.status),
}));
...
export const engageChatMessages = sqliteTable("engage_chat_messages", {
  ...
  engageChatMsgIdIdx: index("idx_pg_engage_chat_msg_id").on(t.messageId),
  engageChatMsgSeshIdx: index("idx_pg_engage_chat_msg_sesh").on(t.sessionId),
}));
...
export const engageTranslations = sqliteTable("engage_translations", {
  ...
  isHumanVerified: boolean("is_human_verified").notNull().default(false),
  verifiedBy: text("verified_by"),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  engageTransHashIdx: index("idx_pg_engage_trans_hash").on(t.contentHash),
  engageTransLangIdx: index("idx_pg_engage_trans_lang").on(t.targetLanguage),
}));
...
export const engageAnalyticsEvents = sqliteTable("engage_analytics_events", {
  ...
  engageEvtIdIdx: index("idx_pg_engage_evt_id").on(t.eventId),
  engageEvtTypeIdx: index("idx_pg_engage_evt_type").on(t.eventType),
  engageEvtCampaignIdx: index("idx_pg_engage_evt_campaign").on(t.campaignId),
}));
...
export const ecoEnergyAssets = sqliteTable("eco_energy_assets", {
  ...
  ecoAssetIdIdx: index("idx_pg_eco_asset_id").on(t.assetId),
  ecoAssetFacIdx: index("idx_pg_eco_asset_fac").on(t.facilityId),
  ecoAssetTypeIdx: index("idx_pg_eco_asset_type").on(t.assetType),
  ecoAssetStatusIdx: index("idx_pg_eco_asset_status").on(t.status),
}));
...
export const ecoGenerationSources = sqliteTable("eco_generation_sources", {
  ...
  ecoGenSourceIdIdx: index("idx_pg_eco_gen_source_id").on(t.sourceId),
  ecoGenAssetIdIdx: index("idx_pg_eco_gen_asset_id").on(t.assetId),
  ecoGenTypeIdx: index("idx_pg_eco_gen_type").on(t.sourceType),
}));
...
export const ecoStorageBatteries = sqliteTable("eco_storage_batteries", {
  ...
  ecoBatIdIdx: index("idx_pg_eco_bat_id").on(t.batteryId),
  ecoBatAssetIdx: index("idx_pg_eco_bat_asset").on(t.assetId),
  ecoBatModeIdx: index("idx_pg_eco_bat_mode").on(t.dispatchMode),
}));
...
export const ecoGridTariffs = sqliteTable("eco_grid_tariffs", {
  ...
  ecoTariffIdIdx: index("idx_pg_eco_tariff_id").on(t.tariffId),
  ecoTariffProviderIdx: index("idx_pg_eco_tariff_provider").on(t.providerName),
}));
...
export const ecoTelemetryEnergy = sqliteTable("eco_telemetry_energy", {
  ...
  ecoTelemIdIdx: index("idx_pg_eco_telem_id").on(t.telemetryId),
  ecoTelemAssetIdx: index("idx_pg_eco_telem_asset").on(t.assetId),
  ecoTelemTypeIdx: index("idx_pg_eco_telem_type").on(t.sourceType),
  ecoTelemTimeIdx: index("idx_pg_eco_telem_time").on(t.recordedAt),
}));
...
export const ecoCarbonEmissions = sqliteTable("eco_carbon_emissions", {
  ...
  ecoEmissionIdIdx: index("idx_pg_eco_emission_id").on(t.emissionId),
  ecoEmissionFacIdx: index("idx_pg_eco_emission_fac").on(t.facilityId),
  ecoEmissionDeptIdx: index("idx_pg_eco_emission_dept").on(t.departmentId),
  ecoEmissionScopeIdx: index("idx_pg_eco_emission_scope").on(t.scope),
  ecoEmissionDateIdx: index("idx_pg_eco_emission_date").on(t.activityDate),
}));
...
export const ecoEvChargingStations = sqliteTable("eco_ev_charging_stations", {
  ...
  isV2GEnabled: boolean("is_v2g_enabled").notNull().default(true),
  firmwareVersion: text("firmware_version").notNull().default("v2.0.1"),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
  updatedAt: text("updated_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  ecoEvStationIdIdx: index("idx_pg_eco_ev_station_id").on(t.stationId),
  ecoEvStationFacIdx: index("idx_pg_eco_ev_station_fac").on(t.facilityId),
  ecoEvOcppIdx: index("idx_pg_eco_ev_ocpp").on(t.ocppId),
  ecoEvStatusIdx: index("idx_pg_eco_ev_status").on(t.status),
}));
...
export const ecoEvFleetSessions = sqliteTable("eco_ev_fleet_sessions", {
  ...
  ecoEvSessionIdIdx: index("idx_pg_eco_ev_session_id").on(t.sessionId),
  ecoEvSessionStationIdx: index("idx_pg_eco_ev_session_station").on(t.stationId),
  ecoEvSessionVehIdx: index("idx_pg_eco_ev_session_veh").on(t.vehicleId),
  ecoEvSessionStatusIdx: index("idx_pg_eco_ev_session_status").on(t.status),
}));
...
export const ecoEsgReports = sqliteTable("eco_esg_reports", {
  ...
  ecoReportIdIdx: index("idx_pg_eco_report_id").on(t.reportId),
  ecoReportPeriodIdx: index("idx_pg_eco_report_period").on(t.reportingPeriod),
  ecoReportStatusIdx: index("idx_pg_eco_report_status").on(t.status),
}));
...
export const ecoCarbonOffsets = sqliteTable("eco_carbon_offsets", {
  ...
  ecoOffsetIdIdx: index("idx_pg_eco_offset_id").on(t.offsetId),
  ecoOffsetCertIdx: index("idx_pg_eco_offset_cert").on(t.certificateNumber),
  ecoOffsetStatusIdx: index("idx_pg_eco_offset_status").on(t.status),
}));
...
export const visionCameras = sqliteTable("vision_cameras", {
  ...
  isPrivacyMasked: boolean("is_privacy_masked").notNull().default(false),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
  updatedAt: text("updated_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  visionCamIdIdx: index("idx_pg_vision_cam_id").on(t.cameraId),
  visionCamFacIdx: index("idx_pg_vision_cam_fac").on(t.facilityId),
  visionCamZoneIdx: index("idx_pg_vision_cam_zone").on(t.zoneType),
  visionCamStatusIdx: index("idx_pg_vision_cam_status").on(t.status),
}));
...
export const visionDetectionZones = sqliteTable("vision_detection_zones", {
  ...
  visionZoneIdIdx: index("idx_pg_vision_zone_id").on(t.zoneId),
  visionZoneCamIdx: index("idx_pg_vision_zone_cam").on(t.cameraId),
  visionZoneTypeIdx: index("idx_pg_vision_zone_type").on(t.zoneType),
}));
...
export const visionThreatAlerts = sqliteTable("vision_threat_alerts", {
  ...
  visionAlertIdIdx: index("idx_pg_vision_alert_id").on(t.alertId),
  visionAlertCamIdx: index("idx_pg_vision_alert_cam").on(t.cameraId),
  visionAlertThreatIdx: index("idx_pg_vision_alert_threat").on(t.threatType),
  visionAlertSeverityIdx: index("idx_pg_vision_alert_severity").on(t.severity),
  visionAlertStatusIdx: index("idx_pg_vision_alert_status").on(t.status),
  visionAlertTimeIdx: index("idx_pg_vision_alert_time").on(t.detectedAt),
}));
...
export const visionSecurityIncidents = sqliteTable("vision_security_incidents", {
  ...
  visionIncidentIdIdx: index("idx_pg_vision_incident_id").on(t.incidentId),
  visionIncidentFacIdx: index("idx_pg_vision_incident_fac").on(t.facilityId),
  visionIncidentStatusIdx: index("idx_pg_vision_incident_status").on(t.status),
  visionIncidentSeverityIdx: index("idx_pg_vision_incident_severity").on(t.severity),
  visionIncidentOccurIdx: index("idx_pg_vision_incident_occur").on(t.occurredAt),
}));
...
export const visionGuardProfiles = sqliteTable("vision_guard_profiles", {
  ...
  visionGuardIdIdx: index("idx_pg_vision_guard_id").on(t.guardId),
  visionGuardStaffIdx: index("idx_pg_vision_guard_staff").on(t.staffId),
  visionGuardStatusIdx: index("idx_pg_vision_guard_status").on(t.status),
  visionGuardFacIdx: index("idx_pg_vision_guard_fac").on(t.currentFacilityId),
}));
...
export const visionGuardDispatches = sqliteTable("vision_guard_dispatches", {
  ...
  visionDispatchIdIdx: index("idx_pg_vision_dispatch_id").on(t.dispatchId),
  visionDispatchIncIdx: index("idx_pg_vision_dispatch_inc").on(t.incidentId),
  visionDispatchGuardIdx: index("idx_pg_vision_dispatch_guard").on(t.guardId),
  visionDispatchStatusIdx: index("idx_pg_vision_dispatch_status").on(t.responseStatus),
}));
...
export const visionAlprLogs = sqliteTable("vision_alpr_logs", {
  ...
  gateActuated: boolean("gate_actuated").notNull().default(false),
  snapshotUrl: text("snapshot_url"),
  capturedAt: text("captured_at").notNull(),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  visionAlprLogIdIdx: index("idx_pg_vision_alpr_log_id").on(t.logId),
  visionAlprCamIdx: index("idx_pg_vision_alpr_cam").on(t.cameraId),
  visionAlprPlateIdx: index("idx_pg_vision_alpr_plate").on(t.plateNumber),
  visionAlprPermitIdx: index("idx_pg_vision_alpr_permit").on(t.permitStatus),
  visionAlprTimeIdx: index("idx_pg_vision_alpr_time").on(t.capturedAt),
}));
...
export const visionVehicleWhitelist = sqliteTable("vision_vehicle_whitelist", {
  ...
  visionWhitelistPermitIdx: index("idx_pg_vision_whitelist_permit").on(t.permitId),
  visionWhitelistPlateIdx: index("idx_pg_vision_whitelist_plate").on(t.plateNumber),
  visionWhitelistStatusIdx: index("idx_pg_vision_whitelist_status").on(t.status),
  visionWhitelistOwnerIdx: index("idx_pg_vision_whitelist_owner").on(t.ownerType, t.ownerId),
}));
...
export const visionLockdownEvents = sqliteTable("vision_lockdown_events", {
  ...
  egressPathsIlluminated: boolean("egress_paths_illuminated").notNull().default(true),
  ecoMeshIslandingTriggered: boolean("eco_mesh_islanding_triggered").notNull().default(false),
  ...
  visionLockdownIdIdx: index("idx_pg_vision_lockdown_id").on(t.lockdownId),
  visionLockdownScopeIdx: index("idx_pg_vision_lockdown_scope").on(t.scope),
  visionLockdownStatusIdx: index("idx_pg_vision_lockdown_status").on(t.status),
  visionLockdownTimeIdx: index("idx_pg_vision_lockdown_time").on(t.triggeredAt),
}));
...
export const visionPrivacyAuditLogs = sqliteTable("vision_privacy_audit_logs", {
  ...
  visionPrivacyAuditIdIdx: index("idx_pg_vision_privacy_audit_id").on(t.auditId),
  visionPrivacyTypeIdx: index("idx_pg_vision_privacy_type").on(t.eventType),
  visionPrivacyCamIdx: index("idx_pg_vision_privacy_cam").on(t.cameraId),
  visionPrivacyTimeIdx: index("idx_pg_vision_privacy_time").on(t.auditTimestamp),
}));
...
export const curriculumPrograms = sqliteTable("curriculum_programs", {
  ...
  curriculumProgCodeIdx: index("idx_pg_curriculum_prog_code").on(t.programCode),
  curriculumProgDeptIdx: index("idx_pg_curriculum_prog_dept").on(t.departmentId),
  curriculumProgYearIdx: index("idx_pg_curriculum_prog_year").on(t.catalogYear),
  curriculumProgStatusIdx: index("idx_pg_curriculum_prog_status").on(t.status),
}));
...
export const curriculumCourses = sqliteTable("curriculum_courses", {
  ...
  curriculumCourseCodeIdx: index("idx_pg_curriculum_course_code").on(t.courseCode),
  curriculumCourseDeptIdx: index("idx_pg_curriculum_course_dept").on(t.departmentId),
  curriculumCourseLevelIdx: index("idx_pg_curriculum_course_level").on(t.level),
  curriculumCourseTypeIdx: index("idx_pg_curriculum_course_type").on(t.courseType),
  curriculumCourseInstIdx: index("idx_pg_curriculum_course_inst").on(t.institutionId),
}));
...
export const curriculumPrerequisites = sqliteTable("curriculum_prerequisites", {
  ...
  concurrencyAllowed: boolean("concurrency_allowed").notNull().default(false),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  curriculumPrereqCourseIdx: index("idx_pg_curriculum_prereq_course").on(t.courseId),
  curriculumPrereqTargetIdx: index("idx_pg_curriculum_prereq_target").on(t.prerequisiteCourseId),
  curriculumPrereqTypeIdx: index("idx_pg_curriculum_prereq_type").on(t.type),
}));
...
export const curriculumDegreePlans = sqliteTable("curriculum_degree_plans", {
  ...
  curriculumPlanIdIdx: index("idx_pg_curriculum_plan_id").on(t.planId),
  curriculumPlanStudentIdx: index("idx_pg_curriculum_plan_student").on(t.studentId),
  curriculumPlanProgramIdx: index("idx_pg_curriculum_plan_program").on(t.programId),
  curriculumPlanStatusIdx: index("idx_pg_curriculum_plan_status").on(t.status),
}));
...
export const curriculumPlanCourses = sqliteTable("curriculum_plan_courses", {
  ...
  isPrerequisiteSatisfied: boolean("is_prerequisite_satisfied").notNull().default(true),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
  updatedAt: text("updated_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  curriculumPlanCoursePlanIdx: index("idx_pg_curriculum_plancourse_plan").on(t.planId),
  curriculumPlanCourseCourseIdx: index("idx_pg_curriculum_plancourse_course").on(t.courseId),
  curriculumPlanCourseTermIdx: index("idx_pg_curriculum_plancourse_term").on(t.plannedTermIndex),
  curriculumPlanCourseStatusIdx: index("idx_pg_curriculum_plancourse_status").on(t.status),
}));
...
export const curriculumTransferArticulations = sqliteTable("curriculum_transfer_articulations", {
  ...
  curriculumTransferArtIdIdx: index("idx_pg_curriculum_transfer_art_id").on(t.articulationId),
  curriculumTransferStudentIdx: index("idx_pg_curriculum_transfer_student").on(t.studentId),
  curriculumTransferStatusIdx: index("idx_pg_curriculum_transfer_status").on(t.status),
}));
...
export const curriculumAdvisingSessions = sqliteTable("curriculum_advising_sessions", {
  ...
  curriculumAdvisingSessionIdIdx: index("idx_pg_curriculum_advsession_id").on(t.sessionId),
  curriculumAdvisingStudentIdx: index("idx_pg_curriculum_advsession_student").on(t.studentId),
  curriculumAdvisingDomainIdx: index("idx_pg_curriculum_advsession_domain").on(t.activeDomain),
  curriculumAdvisingStatusIdx: index("idx_pg_curriculum_advsession_status").on(t.status),
}));
...
export const curriculumAdvisingMessages = sqliteTable("curriculum_advising_messages", {
  ...
  curriculumAdvMessageSessionIdx: index("idx_pg_curriculum_advmsg_session").on(t.sessionId),
  curriculumAdvMessageSenderIdx: index("idx_pg_curriculum_advmsg_sender").on(t.senderType),
  curriculumAdvMessageTimeIdx: index("idx_pg_curriculum_advmsg_time").on(t.sentAt),
}));
...
export const curriculumRetentionAlerts = sqliteTable("curriculum_retention_alerts", {
  ...
  assignedCounselorId: text("assigned_counselor_id").references(() => staff.id),
  engageOsDispatched: boolean("engage_os_dispatched").notNull().default(false),
  ...
  curriculumAlertIdIdx: index("idx_pg_curriculum_alert_id").on(t.alertId),
  curriculumAlertStudentIdx: index("idx_pg_curriculum_alert_student").on(t.studentId),
  curriculumAlertRiskIdx: index("idx_pg_curriculum_alert_risk").on(t.riskTier),
  curriculumAlertStatusIdx: index("idx_pg_curriculum_alert_status").on(t.status),
}));
...
export const curriculumAuditLogs = sqliteTable("curriculum_audit_logs", {
  ...
  curriculumAuditIdIdx: index("idx_pg_curriculum_audit_id").on(t.auditId),
  curriculumAuditActionIdx: index("idx_pg_curriculum_audit_action").on(t.actionType),
  curriculumAuditStudentIdx: index("idx_pg_curriculum_audit_student").on(t.targetStudentId),
  curriculumAuditTimeIdx: index("idx_pg_curriculum_audit_time").on(t.auditTimestamp),
}));
...
export const facilityEquipment = sqliteTable("facility_equipment", {
  ...
  facilityEquipAssetTagIdx: index("idx_pg_facility_equip_asset_tag").on(t.assetTag),
  facilityEquipCategoryIdx: index("idx_pg_facility_equip_category").on(t.category),
  facilityEquipBuildingIdx: index("idx_pg_facility_equip_building").on(t.buildingId),
  facilityEquipStatusIdx: index("idx_pg_facility_equip_status").on(t.status),
  facilityEquipInstitutionIdx: index("idx_pg_facility_equip_institution").on(t.institutionId),
}));
...
export const facilityTelemetrySensors = sqliteTable("facility_telemetry_sensors", {
  ...
  facilitySensorIdIdx: index("idx_pg_facility_sensor_id").on(t.sensorId),
  facilitySensorEquipIdx: index("idx_pg_facility_sensor_equip").on(t.equipmentId),
  facilitySensorTypeIdx: index("idx_pg_facility_sensor_type").on(t.sensorType),
  facilitySensorStatusIdx: index("idx_pg_facility_sensor_status").on(t.status),
}));
...
export const facilitySensorReadings = sqliteTable("facility_sensor_readings", {
  ...
  facilityReadingIdIdx: index("idx_pg_facility_reading_id").on(t.readingId),
  facilityReadingSensorIdx: index("idx_pg_facility_reading_sensor").on(t.sensorId),
  facilityReadingEquipIdx: index("idx_pg_facility_reading_equip").on(t.equipmentId),
  facilityReadingRecordedIdx: index("idx_pg_facility_reading_recorded").on(t.recordedAt),
  facilityReadingAnomalyIdx: index("idx_pg_facility_reading_anomaly").on(t.isAnomaly),
}));
...
export const facilityPredictiveModels = sqliteTable("facility_predictive_models", {
  ...
  facilityModelIdIdx: index("idx_pg_facility_model_id").on(t.modelId),
  facilityModelCategoryIdx: index("idx_pg_facility_model_category").on(t.equipmentCategory),
  facilityModelTypeIdx: index("idx_pg_facility_model_type").on(t.modelType),
}));
...
export const facilityAnomalyAlerts = sqliteTable("facility_anomaly_alerts", {
  ...
  facilityAlertIdIdx: index("idx_pg_facility_alert_id").on(t.alertId),
  facilityAlertEquipIdx: index("idx_pg_facility_alert_equip").on(t.equipmentId),
  facilityAlertSeverityIdx: index("idx_pg_facility_alert_severity").on(t.severity),
  facilityAlertStatusIdx: index("idx_pg_facility_alert_status").on(t.status),
}));
...
export const facilityWorkOrders = sqliteTable("facility_work_orders", {
  ...
  facilityWoNumberIdx: index("idx_pg_facility_wo_number").on(t.workOrderNumber),
  facilityWoEquipIdx: index("idx_pg_facility_wo_equip").on(t.equipmentId),
  facilityWoStatusIdx: index("idx_pg_facility_wo_status").on(t.status),
  facilityWoPriorityIdx: index("idx_pg_facility_wo_priority").on(t.priority),
  facilityWoTechIdx: index("idx_pg_facility_wo_tech").on(t.assignedTechnicianId),
}));
...
export const facilityPartsInventory = sqliteTable("facility_parts_inventory", {
  ...
  facilityPartNumberIdx: index("idx_pg_facility_part_number").on(t.partNumber),
  facilityPartCategoryIdx: index("idx_pg_facility_part_category").on(t.category),
  facilityPartStockIdx: index("idx_pg_facility_part_stock").on(t.quantityOnHand),
}));
...
export const facilityWorkOrderParts = sqliteTable("facility_work_order_parts", {
  ...
  facilityWoPartWoIdx: index("idx_pg_facility_wopart_wo").on(t.workOrderId),
  facilityWoPartPartIdx: index("idx_pg_facility_wopart_part").on(t.partId),
  facilityWoPartStatusIdx: index("idx_pg_facility_wopart_status").on(t.status),
}));
...
export const facilityContractorRegistry = sqliteTable("facility_contractor_registry", {
  ...
  facilityContractorIdIdx: index("idx_pg_facility_contractor_id").on(t.contractorId),
  facilityContractorStatusIdx: index("idx_pg_facility_contractor_status").on(t.status),
  facilityContractorRatingIdx: index("idx_pg_facility_contractor_rating").on(t.performanceRating),
}));
...
export const facilityAuditLogs = sqliteTable("facility_audit_logs", {
  ...
  facilityAuditIdIdx: index("idx_pg_facility_audit_id").on(t.auditId),
  facilityAuditActionIdx: index("idx_pg_facility_audit_action").on(t.action),
  facilityAuditEntityIdx: index("idx_pg_facility_audit_entity").on(t.entityType, t.entityId),
  facilityAuditTimeIdx: index("idx_pg_facility_audit_time").on(t.timestamp),
}));
...
export const neuroClusters = sqliteTable("neuro_clusters", {
  ...
  neuroClusterIdIdx: index("idx_pg_neuro_cluster_id").on(t.clusterId),
  neuroClusterStatusIdx: index("idx_pg_neuro_cluster_status").on(t.status),
  neuroClusterTypeIdx: index("idx_pg_neuro_cluster_type").on(t.clusterType),
}));
...
export const neuroNodes = sqliteTable("neuro_nodes", {
  ...
  isCloudBurst: boolean("is_cloud_burst").notNull().default(false),
  ...
  neuroNodeIdIdx: index("idx_pg_neuro_node_id").on(t.nodeId),
  neuroNodeClusterIdx: index("idx_pg_neuro_node_cluster").on(t.clusterId),
  neuroNodeStatusIdx: index("idx_pg_neuro_node_status").on(t.status),
  neuroNodeCloudIdx: index("idx_pg_neuro_node_cloud").on(t.isCloudBurst),
}));
...
export const neuroGpus = sqliteTable("neuro_gpus", {
  ...
  nvlinkActive: boolean("nvlink_active").notNull().default(true),
  ...
  neuroGpuIdIdx: index("idx_pg_neuro_gpu_id").on(t.gpuId),
  neuroGpuNodeIdx: index("idx_pg_neuro_gpu_node").on(t.nodeId),
  neuroGpuStatusIdx: index("idx_pg_neuro_gpu_status").on(t.status),
  neuroGpuJobIdx: index("idx_pg_neuro_gpu_job").on(t.currentJobId),
}));
...
export const neuroJobs = sqliteTable("neuro_jobs", {
  ...
  neuroJobIdIdx: index("idx_pg_neuro_job_id").on(t.jobId),
  neuroJobUserIdx: index("idx_pg_neuro_job_user").on(t.userId),
  neuroJobDeptIdx: index("idx_pg_neuro_job_dept").on(t.departmentId),
  neuroJobStatusIdx: index("idx_pg_neuro_job_status").on(t.status),
  neuroJobClusterIdx: index("idx_pg_neuro_job_cluster").on(t.clusterId),
}));
...
export const neuroJobCheckpoints = sqliteTable("neuro_job_checkpoints", {
  ...
  sha256Hash: text("sha256_hash").notNull(),
  isPreemptionEmergency: boolean("is_preemption_emergency").notNull().default(false),
  restoredCount: integer("restored_count").notNull().default(0),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  neuroCheckpointIdIdx: index("idx_pg_neuro_checkpoint_id").on(t.checkpointId),
  neuroCheckpointJobIdx: index("idx_pg_neuro_checkpoint_job").on(t.jobId),
  neuroCheckpointHashIdx: index("idx_pg_neuro_checkpoint_hash").on(t.sha256Hash),
}));
...
export const neuroFairShareQuotas = sqliteTable("neuro_fair_share_quotas", {
  ...
  neuroQuotaDeptIdx: index("idx_pg_neuro_quota_dept").on(t.departmentId),
  neuroQuotaScoreIdx: index("idx_pg_neuro_quota_score").on(t.fairShareScore),
}));
...
export const neuroCloudProviders = sqliteTable("neuro_cloud_providers", {
  ...
  neuroProviderKeyIdx: index("idx_pg_neuro_provider_key").on(t.providerKey),
  neuroProviderEnabledIdx: index("idx_pg_neuro_provider_enabled").on(t.isEnabled),
}));
...
export const neuroSpotPriceHistory = sqliteTable("neuro_spot_price_history", {
  ...
  neuroSpotProviderIdx: index("idx_pg_neuro_spot_provider").on(t.provider),
  neuroSpotModelIdx: index("idx_pg_neuro_spot_model").on(t.gpuModel),
  neuroSpotRecordedIdx: index("idx_pg_neuro_spot_recorded").on(t.recordedAt),
}));
...
export const neuroDatasetProvenance = sqliteTable("neuro_dataset_provenance", {
  ...
  containsPiiPhi: boolean("contains_pii_phi").notNull().default(false),
  ...
  neuroDatasetIdIdx: index("idx_pg_neuro_dataset_id").on(t.datasetId),
  neuroDatasetSealedIdx: index("idx_pg_neuro_dataset_sealed").on(t.isSealed),
  neuroDatasetGrantIdx: index("idx_pg_neuro_dataset_grant").on(t.nsfNihGrantTagged),
}));
...
export const neuroMerkleLineageNodes = sqliteTable("neuro_merkle_lineage_nodes", {
  ...
  neuroLineageNodeHashIdx: index("idx_pg_neuro_lineage_node_hash").on(t.nodeHash),
  neuroLineageParentIdx: index("idx_pg_neuro_lineage_parent").on(t.parentNodeHash),
  neuroLineageJobIdx: index("idx_pg_neuro_lineage_job").on(t.jobId),
  neuroLineageDatasetIdx: index("idx_pg_neuro_lineage_dataset").on(t.datasetId),
}));
...
export const neuroComputeBillingAccounts = sqliteTable("neuro_compute_billing_accounts", {
  ...
  isHardCapLocked: boolean("is_hard_cap_locked").notNull().default(false),
  expiresAt: text("expires_at"),
  ...
  neuroBillingAccountIdx: index("idx_pg_neuro_billing_account").on(t.accountNumber),
  neuroBillingDeptIdx: index("idx_pg_neuro_billing_dept").on(t.departmentId),
  neuroBillingGrantIdx: index("idx_pg_neuro_billing_grant").on(t.grantId),
  neuroBillingStatusIdx: index("idx_pg_neuro_billing_status").on(t.status),
}));
...
export const neuroGrantCreditAllocations = sqliteTable("neuro_grant_credit_allocations", {
  ...
  neuroAllocIdIdx: index("idx_pg_neuro_alloc_id").on(t.allocationId),
  neuroAllocAccountIdx: index("idx_pg_neuro_alloc_account").on(t.accountId),
  neuroAllocGrantIdx: index("idx_pg_neuro_alloc_grant").on(t.grantNumber),
}));
...
export const neuroBillingLedgerTransactions = sqliteTable("neuro_billing_ledger_transactions", {
  ...
  neuroLedgerTxIdIdx: index("idx_pg_neuro_ledger_tx_id").on(t.transactionId),
  neuroLedgerAccountIdx: index("idx_pg_neuro_ledger_account").on(t.accountId),
  neuroLedgerJobIdx: index("idx_pg_neuro_ledger_job").on(t.jobId),
  neuroLedgerTypeIdx: index("idx_pg_neuro_ledger_type").on(t.transactionType),
}));
...
export const neuroAuditLogs = sqliteTable("neuro_audit_logs", {
  ...
  neuroAuditIdIdx: index("idx_pg_neuro_audit_id").on(t.auditId),
  neuroAuditActionIdx: index("idx_pg_neuro_audit_action").on(t.action),
  neuroAuditEntityIdx: index("idx_pg_neuro_audit_entity").on(t.entityType, t.entityId),
  neuroAuditTimeIdx: index("idx_pg_neuro_audit_time").on(t.timestamp),
}));
...
export const supplyVendors = sqliteTable("supply_vendors", {
  ...
  isSanctionsClean: boolean("is_sanctions_clean").notNull().default(true),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
  updatedAt: text("updated_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  supplyVendorCodeIdx: index("idx_pg_supply_vendor_code").on(t.vendorCode),
  supplyVendorCategoryIdx: index("idx_pg_supply_vendor_category").on(t.category),
  supplyVendorStatusIdx: index("idx_pg_supply_vendor_status").on(t.onboardingStatus),
  supplyVendorRiskIdx: index("idx_pg_supply_vendor_risk").on(t.riskTier),
}));
...
export const supplyVendorCertifications = sqliteTable("supply_vendor_certifications", {
  ...
  supplyCertVendorIdx: index("idx_pg_supply_cert_vendor").on(t.vendorId),
  supplyCertTypeIdx: index("idx_pg_supply_cert_type").on(t.certType),
  supplyCertStatusIdx: index("idx_pg_supply_cert_status").on(t.verificationStatus),
}));
...
export const supplyVendorRiskAssessments = sqliteTable("supply_vendor_risk_assessments", {
  ...
  sanctionsMatched: boolean("sanctions_matched").notNull().default(false),
  pepMatched: boolean("pep_matched").notNull().default(false),
  ...
  supplyRiskAssmtIdIdx: index("idx_pg_supply_risk_assmt_id").on(t.assessmentId),
  supplyRiskVendorIdx: index("idx_pg_supply_risk_vendor").on(t.vendorId),
  supplyRiskActionIdx: index("idx_pg_supply_risk_action").on(t.recommendedAction),
}));
...
export const supplyVendorEsgScores = sqliteTable("supply_vendor_esg_scores", {
  ...
  fairLaborCertified: boolean("fair_labor_certified").notNull().default(false),
  ratingGrade: text("rating_grade").notNull().default("A"), // 'AAA' | 'AA' | 'A' | 'BBB' | 'BB' | 'B' | 'CCC'
  auditYear: integer("audit_year").notNull().default(2026),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  supplyEsgScoreIdIdx: index("idx_pg_supply_esg_score_id").on(t.scoreId),
  supplyEsgVendorIdx: index("idx_pg_supply_esg_vendor").on(t.vendorId),
  supplyEsgGradeIdx: index("idx_pg_supply_esg_grade").on(t.ratingGrade),
}));
...
export const supplyPurchaseRequisitions = sqliteTable("supply_purchase_requisitions", {
  ...
  supplyReqNumberIdx: index("idx_pg_supply_req_number").on(t.requisitionNumber),
  supplyReqDeptIdx: index("idx_pg_supply_req_dept").on(t.departmentId),
  supplyReqStatusIdx: index("idx_pg_supply_req_status").on(t.status),
  supplyReqTierIdx: index("idx_pg_supply_req_tier").on(t.currentApprovalTier),
}));
...
export const supplyPurchaseOrders = sqliteTable("supply_purchase_orders", {
  ...
  isEncumbered: boolean("is_encumbered").notNull().default(true),
  ...
  supplyPoNumberIdx: index("idx_pg_supply_po_number").on(t.poNumber),
  supplyPoVendorIdx: index("idx_pg_supply_po_vendor").on(t.vendorId),
  supplyPoDeptIdx: index("idx_pg_supply_po_dept").on(t.departmentId),
  supplyPoStatusIdx: index("idx_pg_supply_po_status").on(t.status),
}));
...
export const supplyPoLineItems = sqliteTable("supply_po_line_items", {
  ...
  supplyPoLinePoIdx: index("idx_pg_supply_po_line_po").on(t.poId),
  supplyPoLineSkuIdx: index("idx_pg_supply_po_line_sku").on(t.itemSku),
  supplyPoLineStatusIdx: index("idx_pg_supply_po_line_status").on(t.status),
}));
...
export const supplyGoodsReceipts = sqliteTable("supply_goods_receipts", {
  ...
  supplyReceiptNumberIdx: index("idx_pg_supply_receipt_number").on(t.receiptNumber),
  supplyReceiptPoIdx: index("idx_pg_supply_receipt_po").on(t.poId),
  supplyReceiptVendorIdx: index("idx_pg_supply_receipt_vendor").on(t.vendorId),
  supplyReceiptStatusIdx: index("idx_pg_supply_receipt_status").on(t.status),
}));
...
export const supplyVendorInvoices = sqliteTable("supply_vendor_invoices", {
  ...
  supplyInvNumberIdx: index("idx_pg_supply_inv_number").on(t.invoiceNumber),
  supplyInvVendorIdx: index("idx_pg_supply_inv_vendor").on(t.vendorId),
  supplyInvPoIdx: index("idx_pg_supply_inv_po").on(t.poId),
  supplyInvStatusIdx: index("idx_pg_supply_inv_status").on(t.status),
}));
...
export const supplyThreeWayMatches = sqliteTable("supply_three_way_matches", {
  ...
  isToleranceCompliant: boolean("is_tolerance_compliant").notNull().default(true),
  overrideApprovedByUserId: text("override_approved_by_user_id"),
  overrideJustification: text("override_justification"),
  debitMemoGenerated: boolean("debit_memo_generated").notNull().default(false),
  debitMemoAmountUsd: real("debit_memo_amount_usd").notNull().default(0.0),
  paymentVoucherCode: text("payment_voucher_code"),
  institutionId: text("institution_id").notNull().default("global"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  supplyMatchIdIdx: index("idx_pg_supply_match_id").on(t.matchId),
  supplyMatchInvoiceIdx: index("idx_pg_supply_match_invoice").on(t.invoiceId),
  supplyMatchPoIdx: index("idx_pg_supply_match_po").on(t.poId),
  supplyMatchStatusIdx: index("idx_pg_supply_match_status").on(t.matchStatus),
}));
...
export const supplyContracts = sqliteTable("supply_contracts", {
  ...
  supplyContractCodeIdx: index("idx_pg_supply_contract_code").on(t.contractCode),
  supplyContractVendorIdx: index("idx_pg_supply_contract_vendor").on(t.vendorId),
  supplyContractStatusIdx: index("idx_pg_supply_contract_status").on(t.status),
  supplyContractEndIdx: index("idx_pg_supply_contract_end").on(t.effectiveEndDate),
}));
...
export const supplyContractMilestones = sqliteTable("supply_contract_milestones", {
  ...
  supplyMilestoneIdIdx: index("idx_pg_supply_milestone_id").on(t.milestoneId),
  supplyMilestoneContractIdx: index("idx_pg_supply_milestone_contract").on(t.contractId),
  supplyMilestoneStatusIdx: index("idx_pg_supply_milestone_status").on(t.status),
}));
...
export const supplyBudgetEncumbrances = sqliteTable("supply_budget_encumbrances", {
  ...
  supplyEncumberNumIdx: index("idx_pg_supply_encumber_num").on(t.encumbranceNumber),
  supplyEncumberDeptIdx: index("idx_pg_supply_encumber_dept").on(t.departmentId),
  supplyEncumberPoIdx: index("idx_pg_supply_encumber_po").on(t.poId),
  supplyEncumberStatusIdx: index("idx_pg_supply_encumber_status").on(t.status),
}));
...
export const supplyAuditLogs = sqliteTable("supply_audit_logs", {
  ...
  supplyAuditIdIdx: index("idx_pg_supply_audit_id").on(t.auditId),
  supplyAuditActionIdx: index("idx_pg_supply_audit_action").on(t.action),
  supplyAuditEntityIdx: index("idx_pg_supply_audit_entity").on(t.entityType, t.entityId),
  supplyAuditTimeIdx: index("idx_pg_supply_audit_time").on(t.timestamp),
}));
...
export const timetableSlots = sqliteTable("timetable_slots", {
  ...
  instSlotIdx: index("idx_pg_timetable_slots_inst").on(t.institutionId),
}));
...
export const timetableEntries = sqliteTable("timetable_entries", {
  ...
  entryClassDayIdx: index("idx_pg_timetable_entries_class_day").on(t.classId, t.dayOfWeek),
  entryTeacherIdx: index("idx_pg_timetable_entries_teacher").on(t.teacherId),
  entryInstIdx: index("idx_pg_timetable_entries_inst").on(t.institutionId),
}));
...
export const teacherSubstitutions = sqliteTable("teacher_substitutions", {
  ...
  substDateIdx: index("idx_pg_substitutions_date").on(t.date),
  substTeacherIdx: index("idx_pg_substitutions_sub_teacher").on(t.substituteTeacherId),
}));
...
export const studentEnquiries = sqliteTable("student_enquiries", {
  ...
  enquiryInstStatusIdx: index("idx_pg_student_enquiries_inst_status").on(t.institutionId, t.status),
}));
...
export const campusAffiliations = sqliteTable("campus_affiliations", {
  ...
  affiliationStatusIdx: index("idx_pg_campus_affiliations_status").on(t.status),
}));
...
export const circularCampusCompliance = sqliteTable("circular_campus_compliance", {
  ...
  complianceCircInstIdx: uniqueIndex("idx_pg_circular_compliance_circ_inst").on(t.circularId, t.institutionId),
}));
...
export const docTemplates = sqliteTable("doc_templates", {
  ...
  docTemplateInstIdx: index("idx_pg_doc_templates_inst").on(t.institutionId),
  docTemplateCodeIdx: index("idx_pg_doc_templates_code").on(t.templateCode),
  docTemplateCategoryIdx: index("idx_pg_doc_templates_category").on(t.category),
}));
...
export const docGeneratedRecords = sqliteTable("doc_generated_records", {
  ...
  docGenInstIdx: index("idx_pg_doc_gen_inst").on(t.institutionId),
  docGenRecipientIdx: index("idx_pg_doc_gen_recipient").on(t.recipientType, t.recipientId),
  docGenHashIdx: index("idx_pg_doc_gen_hash").on(t.documentHash),
  docGenSerialIdx: index("idx_pg_doc_gen_serial").on(t.serialNumber),
  docGenStatusIdx: index("idx_pg_doc_gen_status").on(t.status),
}));
...
export const docVerificationSignatures = sqliteTable("doc_verification_signatures", {
  ...
  docVerifHashIdx: index("idx_pg_doc_verif_hash").on(t.documentHash),
  docVerifRecordIdx: index("idx_pg_doc_verif_record").on(t.documentRecordId),
}));
...
export const exportJobs = sqliteTable("export_jobs", {
  ...
  exportJobsInstIdx: index("idx_pg_export_jobs_inst").on(t.institutionId),
  exportJobsUserIdx: index("idx_pg_export_jobs_user").on(t.userId),
  exportJobsStatusIdx: index("idx_pg_export_jobs_status").on(t.status),
}));
...
export const exportTemplates = sqliteTable("export_templates", {
  ...
  exportTemplatesInstIdx: index("idx_pg_export_templates_inst").on(t.institutionId),
  exportTemplatesEntityIdx: index("idx_pg_export_templates_entity").on(t.entityType),
}));
...
export const mobileSyncEvents = sqliteTable("mobile_sync_events", {
  ...
  mobileSyncInstIdx: index("idx_pg_mobile_sync_inst").on(t.institutionId),
  mobileSyncTypeIdx: index("idx_pg_mobile_sync_type").on(t.eventType),
  mobileSyncTimeIdx: index("idx_pg_mobile_sync_time").on(t.createdAt),
}));
...
export const mobileDeviceTokens = sqliteTable("mobile_device_tokens", {
  ...
  mobileDeviceUserIdx: index("idx_pg_mobile_device_user").on(t.userId),
  mobileDeviceInstIdx: index("idx_pg_mobile_device_inst").on(t.institutionId),
  mobileDeviceTokenIdx: index("idx_pg_mobile_device_token").on(t.deviceToken),
}));
...
export const mobilePushLogs = sqliteTable("mobile_push_logs", {
  ...
  mobilePushInstIdx: index("idx_pg_mobile_push_inst").on(t.institutionId),
  mobilePushUserIdx: index("idx_pg_mobile_push_user").on(t.recipientUserId),
  mobilePushStatusIdx: index("idx_pg_mobile_push_status").on(t.status),
}));
...
export const docAuditLogs = sqliteTable("doc_audit_logs", {
  ...
  docAuditIdIdx: index("idx_pg_doc_audit_id").on(t.auditId),
  docAuditActionIdx: index("idx_pg_doc_audit_action").on(t.action),
  docAuditEntityIdx: index("idx_pg_doc_audit_entity").on(t.entityType, t.entityId),
  docAuditTimeIdx: index("idx_pg_doc_audit_time").on(t.timestamp),
}));
...
export const feeStructures = sqliteTable("fee_structures", {
  ...
  feeStructInstIdx: index("idx_pg_fee_structures_inst").on(t.institutionId),
  feeStructCodeIdx: index("idx_pg_fee_structures_code").on(t.code),
  feeStructYearIdx: index("idx_pg_fee_structures_year").on(t.academicYear),
}));
...
export const feeStructureComponents = sqliteTable("fee_structure_components", {
  ...
  feeCompStructIdx: index("idx_pg_fee_components_struct").on(t.feeStructureId),
  feeCompTypeIdx: index("idx_pg_fee_components_type").on(t.componentType),
}));
...
export const feeStudentAllocations = sqliteTable("fee_student_allocations", {
  ...
  feeAllocInstIdx: index("idx_pg_fee_alloc_inst").on(t.institutionId),
  feeAllocStudentIdx: index("idx_pg_fee_alloc_student").on(t.studentId),
  feeAllocStructIdx: index("idx_pg_fee_alloc_struct").on(t.feeStructureId),
  feeAllocStatusIdx: index("idx_pg_fee_alloc_status").on(t.status),
}));
...
export const feeInstallments = sqliteTable("fee_installments", {
  ...
  feeInstAllocIdx: index("idx_pg_fee_inst_alloc").on(t.allocationId),
  feeInstDueIdx: index("idx_pg_fee_inst_due").on(t.dueDate),
  feeInstStatusIdx: index("idx_pg_fee_inst_status").on(t.status),
}));
...
export const feePayments = sqliteTable("fee_payments", {
  ...
  feePayInstIdx: index("idx_pg_fee_pay_inst").on(t.institutionId),
  feePayAllocIdx: index("idx_pg_fee_pay_alloc").on(t.allocationId),
  feePayStudentIdx: index("idx_pg_fee_pay_student").on(t.studentId),
  feePayNumberIdx: index("idx_pg_fee_pay_number").on(t.paymentNumber),
  feePayStatusIdx: index("idx_pg_fee_pay_status").on(t.paymentStatus),
}));
...
export const feePaymentTransactions = sqliteTable("fee_payment_transactions", {
  ...
  feeTxPaymentIdx: index("idx_pg_fee_tx_payment").on(t.paymentId),
  feeTxInstIdx: index("idx_pg_fee_tx_installment").on(t.installmentId),
}));
...
export const feeReceipts = sqliteTable("fee_receipts", {
  ...
  feeRcptInstIdx: index("idx_pg_fee_rcpt_inst").on(t.institutionId),
  feeRcptNumberIdx: index("idx_pg_fee_rcpt_number").on(t.receiptNumber),
  feeRcptHashIdx: index("idx_pg_fee_rcpt_hash").on(t.receiptHash),
  feeRcptStudentIdx: index("idx_pg_fee_rcpt_student").on(t.studentId),
}));
...
export const feeScholarships = sqliteTable("fee_scholarships", {
  ...
  feeSchInstIdx: index("idx_pg_fee_sch_inst").on(t.institutionId),
  feeSchCodeIdx: index("idx_pg_fee_sch_code").on(t.code),
  feeSchYearIdx: index("idx_pg_fee_sch_year").on(t.academicYear),
}));
...
export const feeConcessions = sqliteTable("fee_concessions", {
  ...
  feeConcInstIdx: index("idx_pg_fee_conc_inst").on(t.institutionId),
  feeConcStudentIdx: index("idx_pg_fee_conc_student").on(t.studentId),
  feeConcAllocIdx: index("idx_pg_fee_conc_alloc").on(t.allocationId),
  feeConcStatusIdx: index("idx_pg_fee_conc_status").on(t.status),
}));
...
export const feeCounterRegisters = sqliteTable("fee_counter_registers", {
  ...
  feeCountInstIdx: index("idx_pg_fee_count_inst").on(t.institutionId),
  feeCountCashierIdx: index("idx_pg_fee_count_cashier").on(t.cashierId),
  feeCountStatusIdx: index("idx_pg_fee_count_status").on(t.status),
}));
...
export const feeDefaulterLogs = sqliteTable("fee_defaulter_logs", {
  ...
  feeDefInstIdx: index("idx_pg_fee_def_inst").on(t.institutionId),
  feeDefStudentIdx: index("idx_pg_fee_def_student").on(t.studentId),
  feeDefBucketIdx: index("idx_pg_fee_def_bucket").on(t.agingBucket),
}));
...
export const feeReconciliationBatches = sqliteTable("fee_reconciliation_batches", {
  ...
  feeReconInstIdx: index("idx_pg_fee_recon_inst").on(t.institutionId),
  feeReconBatchIdx: index("idx_pg_fee_recon_batch").on(t.batchNumber),
  feeReconStatusIdx: index("idx_pg_fee_recon_status").on(t.status),
}));
...
export const feeAuditLogs = sqliteTable("fee_audit_logs", {
  ...
  feeAuditIdIdx: index("idx_pg_fee_audit_id").on(t.auditId),
  feeAuditActionIdx: index("idx_pg_fee_audit_action").on(t.action),
  feeAuditEntityIdx: index("idx_pg_fee_audit_entity").on(t.entityType, t.entityId),
  feeAuditTimeIdx: index("idx_pg_fee_audit_time").on(t.timestamp),
}));
...
export const alumniProfiles = sqliteTable("alumni_profiles", {
  ...
  alumProfInstIdx: index("idx_pg_alum_prof_inst").on(t.institutionId),
  alumProfEmailIdx: index("idx_pg_alum_prof_email").on(t.email),
  alumProfBatchIdx: index("idx_pg_alum_prof_batch").on(t.graduationBatchYear),
  alumProfStatusIdx: index("idx_pg_alum_prof_status").on(t.status),
  alumProfStudentIdx: index("idx_pg_alum_prof_student").on(t.studentId),
}));
...
export const alumniEducations = sqliteTable("alumni_educations", {
  ...
  isInstitutional: boolean("is_institutional").notNull().default(false),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
  updatedAt: text("updated_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  alumEduProfIdx: index("idx_pg_alum_edu_prof").on(t.alumniProfileId),
}));
...
export const alumniExperiences = sqliteTable("alumni_experiences", {
  ...
  alumExpProfIdx: index("idx_pg_alum_exp_prof").on(t.alumniProfileId),
  alumExpCompanyIdx: index("idx_pg_alum_exp_company").on(t.company),
}));
...
export const alumniMentorshipProfiles = sqliteTable("alumni_mentorship_profiles", {
  ...
  alumMentorInstIdx: index("idx_pg_alum_mentor_inst").on(t.institutionId),
  alumMentorProfIdx: index("idx_pg_alum_mentor_prof").on(t.alumniProfileId),
}));
...
export const alumniMentorshipRequests = sqliteTable("alumni_mentorship_requests", {
  ...
  alumReqInstIdx: index("idx_pg_alum_req_inst").on(t.institutionId),
  alumReqMentorIdx: index("idx_pg_alum_req_mentor").on(t.mentorshipProfileId),
  alumReqStudentIdx: index("idx_pg_alum_req_student").on(t.studentId),
  alumReqStatusIdx: index("idx_pg_alum_req_status").on(t.status),
}));
...
export const alumniMentorshipSessions = sqliteTable("alumni_mentorship_sessions", {
  ...
  alumSessReqIdx: index("idx_pg_alum_sess_req").on(t.requestId),
  alumSessMentorIdx: index("idx_pg_alum_sess_mentor").on(t.mentorshipProfileId),
  alumSessStudentIdx: index("idx_pg_alum_sess_student").on(t.studentId),
  alumSessStatusIdx: index("idx_pg_alum_sess_status").on(t.status),
}));
...
export const alumniJobPostings = sqliteTable("alumni_job_postings", {
  ...
  allowDirectApply: boolean("allow_direct_apply").notNull().default(true),
  hasAlumniReferral: boolean("has_alumni_referral").notNull().default(false),
  ...
  alumJobInstIdx: index("idx_pg_alum_job_inst").on(t.institutionId),
  alumJobStatusIdx: index("idx_pg_alum_job_status").on(t.status),
  alumJobCompanyIdx: index("idx_pg_alum_job_company").on(t.company),
}));
...
export const alumniJobApplications = sqliteTable("alumni_job_applications", {
  ...
  alumAppJobIdx: index("idx_pg_alum_app_job").on(t.jobPostingId),
  alumAppStudentIdx: index("idx_pg_alum_app_student").on(t.studentId),
  alumAppStatusIdx: index("idx_pg_alum_app_status").on(t.status),
}));
...
export const alumniDonationCampaigns = sqliteTable("alumni_donation_campaigns", {
  ...
  isTaxExempt80G: boolean("is_tax_exempt_80g").notNull().default(true),
  matchingDonorName: text("matching_donor_name"),
  matchingRatio: real("matching_ratio").default(1.0),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
  updatedAt: text("updated_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  alumCampInstIdx: index("idx_pg_alum_camp_inst").on(t.institutionId),
  alumCampCodeIdx: index("idx_pg_alum_camp_code").on(t.code),
  alumCampStatusIdx: index("idx_pg_alum_camp_status").on(t.status),
}));
...
export const alumniDonations = sqliteTable("alumni_donations", {
  ...
  isCorporateMatching: boolean("is_corporate_matching").notNull().default(false),
  corporateEmployerName: text("corporate_employer_name"),
  confirmedAt: text("confirmed_at"),
  createdAt: text("created_at").notNull().default(sql`(current_timestamp)`),
}, (t) => ({
  alumDonInstIdx: index("idx_pg_alum_don_inst").on(t.institutionId),
  alumDonCampIdx: index("idx_pg_alum_don_camp").on(t.campaignId),
  alumDonAlumIdx: index("idx_pg_alum_don_alum").on(t.alumniProfileId),
  alumDonRcptIdx: index("idx_pg_alum_don_rcpt").on(t.receipt80GNumber),
  alumDonStatusIdx: index("idx_pg_alum_don_status").on(t.status),
}));
...
export const alumniChapters = sqliteTable("alumni_chapters", {
  ...
  alumChapInstIdx: index("idx_pg_alum_chap_inst").on(t.institutionId),
  alumChapCodeIdx: index("idx_pg_alum_chap_code").on(t.code),
  alumChapStatusIdx: index("idx_pg_alum_chap_status").on(t.status),
}));
...
export const alumniChapterMembers = sqliteTable("alumni_chapter_members", {
  ...
  alumMemChapIdx: index("idx_pg_alum_mem_chap").on(t.chapterId),
  alumMemProfIdx: index("idx_pg_alum_mem_prof").on(t.alumniProfileId),
}));
...
export const alumniEvents = sqliteTable("alumni_events", {
  ...
  alumEvtInstIdx: index("idx_pg_alum_evt_inst").on(t.institutionId),
  alumEvtChapIdx: index("idx_pg_alum_evt_chap").on(t.chapterId),
  alumEvtStatusIdx: index("idx_pg_alum_evt_status").on(t.status),
  alumEvtDateIdx: index("idx_pg_alum_evt_date").on(t.startDateTime),
}));
...
export const alumniEventRsvps = sqliteTable("alumni_event_rsvps", {
  ...
  alumRsvpEvtIdx: index("idx_pg_alum_rsvp_evt").on(t.eventId),
  alumRsvpTicketIdx: index("idx_pg_alum_rsvp_ticket").on(t.ticketNumber),
  alumRsvpHashIdx: index("idx_pg_alum_rsvp_hash").on(t.ticketPassHash),
}));
...
export const alumniAuditLogs = sqliteTable("alumni_audit_logs", {
  ...
  alumAuditIdIdx: index("idx_pg_alum_audit_id").on(t.auditId),
  alumAuditActionIdx: index("idx_pg_alum_audit_action").on(t.action),
  alumAuditEntityIdx: index("idx_pg_alum_audit_entity").on(t.entityType, t.entityId),
