...
final updateServiceProvider = Provider<UpdateService>((ref) {
  ...
  final loggerSvc = ref.watch(loggerServiceProvider);
  return UpdateService(api, loggerSvc);
});
...
final updateStateProvider = StateNotifierProvider<UpdateStateNotifier, UpdateDownloadState>((ref) {
  final service = ref.watch(updateServiceProvider);
...
class UpdateStateNotifier extends StateNotifier<UpdateDownloadState> {
  ...
  UpdateStateNotifier(this._service, this._ref) : super(UpdateDownloadState.idle);
