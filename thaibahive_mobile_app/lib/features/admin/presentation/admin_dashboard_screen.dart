          ...
          : ListView(
              ...
              children: [
                ...
                _adminCard(
                  ...
                  subtitle: 'Register staff cards & checkpoints',
                  color: Colors.indigo,
                  onTap: () => context.push('/admin/nfc-tags'),
                ),
                _adminCard(
                  icon: Icons.qr_code_2_rounded,
                  title: 'Location QR Checkpoints',
                  subtitle: 'Dynamic TOTP & printable gate QR codes',
                  color: Colors.purple,
                  onTap: () => context.push('/admin/location-qr'),
                ),
                _adminCard(
                  icon: Icons.qr_code_scanner_rounded,
                  title: 'Asset QR / NFC Tagging',
                  subtitle: 'Bind barcodes & NFC tags to equipment',
                  color: Colors.teal,
                  onTap: () => context.push('/assets/tagging'),
                ),
                _adminCard(
                  icon: Icons.bluetooth_searching_rounded,
                  title: 'BLE Beacon Pairing',
                  subtitle: 'Pair Bluetooth beacons to campus locations',
                  color: Colors.deepOrange,
                  onTap: () => context.push('/admin/beacons'),
                ),
                _adminCard(
                  icon: Icons.badge_rounded,
                  title: 'Visitor Gate Pass Verification',
                  subtitle: 'Security gate QR scanner & visitor check-in',
                  color: Colors.amber.shade800,
                  onTap: () => context.push('/visitors/gate-verify'),
                ),
              ],
            ),
    );
